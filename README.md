...
![image-20240531150554354](C:\Users\15486\AppData\Roaming\Typora\typora-user-images\image-20240531150554354.png)
...
![image-20240531152103148](C:\Users\15486\AppData\Roaming\Typora\typora-user-images\image-20240531152103148.png)
...
![table3](https://github.com/Harris-H/PatchTST/pic/table3.png)

### 3.2 自我监督学习

与其他监督和自监督模型进行了比较，自监督 PatchTST 能够优于所有基线。

![table4](https://github.com/Harris-H/PatchTST/pic/table4.png)

![table6](https://github.com/Harris-H/PatchTST/pic/table6.png)

我们还测试了将预训练模型转移到下游任务的能力。

![table5](https://github.com/Harris-H/PatchTST/pic/table5.png)

### 3.3 长回溯窗口的效率

随着回溯窗口的增加，PatchTST 会持续降低 MSE 分数，这证实了模型能够从更长的感受野中学习。

![varying_L](https://github.com/Harris-H/PatchTST/pic/varying_L.png)
...
![test_result](https://github.com/Harris-H/PatchTST/pic/96_test_result.png)
...
![image-20240531160648084](https://github.com/Harris-H/PatchTST/pic/192_test_result.png)
